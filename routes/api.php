...
Route::middleware("auth:sanctum")->group(function () {
    ...
    Route::prefix('visitations')->group(function () {
        ...
        Route::get('{id}/previous-lab-requests', [VisitationController::class, 'getPreviousLabRequests']);
    ...
    Route::prefix('test-requests')->group(function () {
        ...
        Route::get('/{id}/download-result', [LabRequestController::class, 'downloadTestResult']);
